...
export const SearchBar: React.FC<SearchBarProps> = ({
  ...
  <div className={`relative ${className}`}>
    ...
    <input
      ...
      className="w-full text-xs pl-10 pr-4 py-2.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
      {...rest}
    />
  </div>
);
