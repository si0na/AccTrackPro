...
const stakeholdersConfig: ModuleIEConfig = {
  ...
  fields: [
    ...
    { key: 'influence', header: 'Interest (Client) / Influence (SP)', type: 'enum', options: INFLUENCE, required: true, example: 'High' },
  ...
  exportColumns: [
    ...
    { key: 'influence', header: 'Interest (Client) / Influence (SP)', value: (e) => e.influence ?? '' },
